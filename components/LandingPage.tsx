...
export const LandingPage: React.FC<LandingPageProps> = ({ onStart, onNavigate }) => {
  return (
    <div className="flex flex-col min-h-screen bg-white font-sans">
      ...
      <Navbar onNavigate={onNavigate} onStart={onStart} activeView={AppView.LANDING} />

      {/* --- HERO SECTION --- */}
      <header className="pt-32 pb-20 px-6 bg-gradient-to-b from-caramel-50 to-white">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          
          {/* Text Content */}
          <div className="space-y-8 animate-fade-in-up">
            <div className="inline-block px-4 py-1.5 rounded-full bg-caramel-100 text-caramel-800 text-sm font-bold tracking-wide mb-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                Falar com Caramelo <ArrowRight size={20} />
              </button>
              <button 
                onClick={() => onNavigate(AppView.OUR_APPROACH)}
                className="bg-white border-2 border-caramel-100 text-caramel-700 hover:bg-caramel-50 text-lg font-bold py-4 px-10 rounded-full transition-all duration-300"
              >
                Como funciona
              </button>
            </div>
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative z-10 rounded-[2.5rem] overflow-hidden shadow-2xl border-8 border-white">
              ...
              />
               {/* Floating Badge */}
               <div className="absolute bottom-8 left-8 bg-white/95 backdrop-blur shadow-lg p-4 rounded-2xl flex items-center gap-3 animate-bounce-slow">
                 <div className="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center text-green-600">
                   <Heart fill="currentColor" size={20} />
                 </div>
                 <div>
                   <p className="text-xs text-gray-500 font-bold uppercase">Status</p>
                   <p className="text-sm font-bold text-gray-800">Pronto para ouvir 🐶</p>
                 </div>
               </div>
            </div>
            
            {/* Background Decor */}
            <div className="absolute top-10 right-10 w-full h-full bg-caramel-200 rounded-[3rem] -z-10 transform translate-x-4 translate-y-4"></div>
          </div>
        </div>
      </header>
      ...
      <section className="py-10 border-y border-gray-100 bg-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
            <h3 className="text-xl md:text-2xl font-bold text-gray-600 flex items-center gap-2"><Globe size={24}/> Saúde Digital</h3>
            <h3 className="text-xl md:text-2xl font-bold text-gray-600">Bem-estar Corporativo</h3>
            <h3 className="text-xl md:text-2xl font-bold text-gray-600">Inovação Social</h3>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
           ...
           <div className="order-2 lg:order-1 relative flex justify-center">
              <div className="w-72 h-[500px] bg-gray-900 rounded-[3rem] p-3 shadow-2xl border-4 border-gray-800 relative z-10">
                 <div className="w-full h-full bg-caramel-50 rounded-[2.5rem] overflow-hidden flex flex-col relative">
                    {/* Fake Chat UI */}
                    ...
                    <div className="p-4 space-y-3 flex-1">
                       <div className="bg-white p-3 rounded-2xl rounded-tl-none shadow-sm max-w-[80%] text-xs text-gray-600">
              ...
              {/* Circle Decor */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-caramel-50 rounded-full -z-10"></div>
           </div>

           {/* Content Direita */}
           <div className="order-1 lg:order-2 space-y-6">
             <div className="inline-block px-4 py-1 rounded-full bg-caramel-100 text-caramel-800 text-sm font-bold mb-2">
               Suporte 24h
             </div>
             ...
             <ul className="space-y-4 pt-4">
               <li className="flex items-center gap-3 text-gray-700 font-medium">
                 <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center text-green-600"><Clock size={16} /></div>
                 Atendimento imediato a qualquer hora.
               </li>
               <li className="flex items-center gap-3 text-gray-700 font-medium">
                 <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-600"><Lock size={16} /></div>
      ...
      {/* --- FEATURE 2: SAFETY & SOS --- */}
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
             <div className="inline-block px-4 py-1 rounded-full bg-red-100 text-red-800 text-sm font-bold mb-2">
               Segurança em Primeiro Lugar
             </div>
             <h2 className="text-4xl font-bold text-gray-900">
               Protocolos éticos e <span className="text-red-500">responsáveis</span>.
             </h2>
             <p className="text-lg text-gray-600 leading-relaxed">
               O Caramelo não faz diagnósticos nem substitui médicos. Nossa IA é treinada para detectar situações de risco e orientar o usuário a buscar ajuda especializada humana imediatamente.
             </p>
             
             <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 mt-6">
               <h4 className="font-bold text-gray-900 flex items-center gap-2 mb-2">
                 <Shield className="text-caramel-600" size={20} />
                 Encaminhamento Responsável
               </h4>
               <p className="text-gray-600 text-sm">
                 Ao identificar sinais de crise, o assistente interrompe o fluxo normal e fornece contatos de emergência (CVV/SAMU).
               </p>
             </div>
          </div>
          ...
          <div className="relative">
             ...
             />
             <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-2xl shadow-xl max-w-xs border-l-4 border-red-500">
               <p className="font-bold text-gray-800 text-lg mb-1">Botão de Ajuda</p>
               <p className="text-gray-500 text-sm">Acesso rápido a linhas de apoio em momentos críticos.</p>
             </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-8 mb-12">
          <div className="space-y-4">
             <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-xl text-gray-800">Caramelo</span>
             </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li><button onClick={() => window.open('mailto:contato@caramelo.ai')} className="hover:text-caramel-600">Contato</button></li>
            </ul>
          </div>
          <div>
            <h4 className="font-bold text-gray-900 mb-4">Produto</h4>
            <ul className="space-y-2 text-sm text-gray-600">
              <li><button onClick={() => onNavigate(AppView.FOR_BUSINESS)} className="hover:text-caramel-600">Para Empresas</button></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li><a href="#" className="hover:text-caramel-600">Termos de Uso</a></li>
              <li><a href="#" className="hover:text-caramel-600">Privacidade</a></li>
            </ul>
          </div>
        </div>
        
        <div className="max-w-7xl mx-auto border-t border-gray-200 pt-8 text-center text-xs text-gray-400">
          <p className="mb-2">
